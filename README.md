...
## 📊 Mô hình nghiên cứu
![Mô hình kiểm định 13 giả thuyết về tác động trực tiếp và gián tiếp (qua vai trò trung gian của sự hài lòng)](https://raw.githubusercontent.com/hatrang-ship-it/Exploring-Perceived-Value-in-Vietnamese-Tourism-A-BERTopic-PLS-SEM-Approach/main/6.%20Smart-PLS/add%20satisfaction_k11.png)
...
```text
├── data/               # Dữ liệu reviews đã xử lý
├── notebooks/          # Notebooks phân tích (Preprocessing, BERTopic, PLS-SEM)
├── models/             # Các mô hình NLP đã train
